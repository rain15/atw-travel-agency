...
Tags: show, template, hierarchy, admin, page, visual
...
= 1.2.0 = Style visual indicator similar to WP Admin tool bar, change hook to _wp_footer_ and admin user can only see the visual indicator whilst logged in. Link to template hierarchy page on WP logo.
